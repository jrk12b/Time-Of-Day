...
describe('Validating contact section elements', () => {
  ...
  it('validate contact header exists', () => {
    ...
    cy.contains('h2', 'CONTACT ME').should('have.css', 'font-size', '20px').and('have.css', 'color', 'rgb(24, 33, 83)');
  });
  ...
  it('validate contact form details', () => {
    ...
    cy.get('div[data-mesh-id="SITE_FOOTERinlineContent"]').within(() => {
      ...
      cy.contains('a', 'justinkurdila@gmail.com').should('have.attr', 'href', 'mailto:justinkurdila@gmail.com');
    })
  });

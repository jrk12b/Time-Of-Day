...
const k6_thresholds = {
	browser_http_req_duration: ['p(95)<12000'], // total time for the request
	browser_http_req_failed: ['rate<0.005'], // the rate of failed requests
	browser_web_vital_lcp: ['p(95)<11000'], // Measures a page's loading performance, specifically Largest Contenful Paint - the render time of the largest image or text block visible in the viewport, relative to when the user first navigated to the page.
	...
	browser_web_vital_fcp: ['p(95)<22000'], // Measures the time it takes for the browser to render the first DOM element on the page, whether that's a text, image or header.

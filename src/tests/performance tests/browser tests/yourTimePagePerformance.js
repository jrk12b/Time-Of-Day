...
const k6_thresholds = {
	browser_http_req_duration: ['p(95)<80000'], // total time for the request
	...
	browser_web_vital_fid: ['p(95)<8000'], // Measures a page's interactivity, specifically First Inout Delay - measures the time from when a user first interacts with a page to the time when the browser is actually able to begin processing.
	...
	browser_web_vital_ttfb: ['p(95)<80000'], // Measures the time it takes between the browser request and the start of the response from a server
	browser_web_vital_fcp: ['p(95)<85000'], // Measures the time it takes for the browser to render the first DOM element on the page, whether that's a text, image or header.
